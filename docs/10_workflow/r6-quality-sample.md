...
| `ts-defect`       | Find the zero-value fallback at `src/client.ts:2`.       | `client.ts:2` uses `                                                                                                        |                                                                                                                                                              | 3000`; unchanged `config.ts:1-2`defines zero as a disabled deadline and sets`timeoutMs: 0`. | A finding without zero semantics is ungrounded. |
