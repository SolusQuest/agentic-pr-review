...
R4 owns the retained deterministic CLI/application/protocol/storage path, C# `Ledger/**` and `Prefix/**`, TypeScript state-v2, GitHub reads and C# publication, production restricted-state transport and keys, the thin Node bridge, and the final public wrapper. W3 removed `src/runtime-invocation/**`, `src/live-runtime-invocation/**`, and the obsolete live-context schema after W2/W7/E1 replacement proof; W6 removed the superseded Git-ref state-acceptance family and its dedicated schemas after S1-S6/P5/P6/E1 proof; W8 removed the TypeScript sticky publisher after P1/P2/P5/P6/E1 proof; and W9 independently removed the TypeScript inline/target publisher after H2/H5/P3/P4/P6/E1 proof. Their checked C# publication evidence remains current. The surviving TypeScript families are not R2 comparison infrastructure and stay only for their named migration consumers.
...
| `StateManifestV2`                                                                                                                                    | consolidate         | R4                | C# Host must first prove provenance, integrity, stale-writer, no-overwrite, atomic acceptance, and safe-bootstrap behavior. One durable session format may retain a small manifest.                                                                  |
