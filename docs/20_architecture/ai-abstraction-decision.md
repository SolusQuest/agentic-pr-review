...
| Reachability correction commit             | `0bf639b245e8cea8c7a8e9ac1826b7549718a133`                                                                                           |
| Reachability correction Ubuntu Runtime CI  | [run 30339680229, runtime job 90212197623](https://github.com/SolusQuest/agentic-pr-review/actions/runs/30339680229/job/90212197623) |
...
| Reachability correction environment        | .NET SDK `10.0.110`; `ubuntu-24.04` image `20260720.247.2`; runner `2.336.0`; `linux-x64`, self-contained Native AOT                 |

The original selection was made at `337bec8000746cd67cb37ca1784732839662b1d9`, which introduced the selected production seam and activated the selected-production parity gate. The later substantive correction commit `f249565aec80a6af1c4eb919d0c5d6d6e210d4ac` repaired and mechanized the evidence without changing that selection. The post-handoff reachability correction `0bf639b245e8cea8c7a8e9ac1826b7549718a133` then preserved the complete neutral build input under the permitted named comparison fixture and removed the verifier's dependency on intermediate Git history. Its Runtime CI validated the manifest-bound snapshot, regenerated and exact-compared all four API manifests, executed both candidates in framework and Native AOT modes, and executed selected-production parity in both modes. This documentation-only record follows that green substantive correction and therefore keeps its own commit SHA and final CI in the PR record rather than attempting a self-reference.
