...
- retained internal TypeScript state only as named R4 replacement evidence; W3 removed the invocation families and obsolete live-context schema, W6 removed the Git-ref state-acceptance family and its dedicated schemas after S1-S6/P5/P6/E1 evidence, W8 removed the sticky publisher after P1/P2/P5/P6/E1 evidence, W9 independently removed the inline/target publisher after H2/H5/P3/P4/P6/E1 evidence, W10 removed the duplicate TypeScript review protocol/structured-result family while preserving the embedded Input/Result/Trace schemas and complete C#-owned fixture corpus, W11 removed the prefix family and generator after C# ownership, immutable-corpus, and E1 continuation proof, and W12 removed the provider-metadata TypeScript surface, schema resource, and dedicated fixture corpus. The W8/W9 checked C# replacement evidence remains current, and W5 retains ownership of its distinct opaque sidecar bytes, descriptors, hashes, and fixtures.
