...
export const residualReferenceRules = [
  ...
  },
  {
    id: 'RR-033',
    term: claudeBrandEvidence,
    path: /^src\/state-v2\/test-helpers\.ts$/u,
    lifecycleClass: 'state-migration',
    currentConsumer: 'StateManifestV2 model-identity fixture helper',
    owner: 'R4 state bridge',
    interpretation:
      'opaque provider/model identity test data, not an executable Claude runtime route',
    deletionGate: 'replace the StateManifestV2 fixture family',
    milestone: 'R4',
  },
  permanent(
    'RR-034',
