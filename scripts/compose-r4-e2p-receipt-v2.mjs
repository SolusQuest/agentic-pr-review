...
function fail(code) {
  process.stderr.write(`APR_R4_E2P_RECEIPT_V2_INVALID ${code}\n`);
  process.exit(1);
}
...
const receipt = {
  ...
  action_source_sha: '5b5769753653bb3fd3e68cf8b7bb88a1bd350613',
...
if (serialized.length > 32768 || /token|secret|credential|prompt/iu.test(serialized)) {
  fail('public-safety');
}
process.stdout.write(`APR_R4_E2P_RECEIPT_V2 ${serialized}\n`);
